                        ...
                        <div class="col-lg-14">
                           <div class="panel panel-default">
                            ...
                            <div class="bootstrap-admin-panel-content">
                                ...
                                ?>        
                                            <tr class="odd gradeX">
                                            <td style="text-align: center; vertical-align: middle;" rowspan="<?php echo $sum?>"><?php echo $num=$num+1?></td>
                                                <td style="text-align: center; vertical-align: middle;" rowspan="<?php echo $sum?>"><?php echo $value->server_name?>&nbsp<a href="javascript:;" class="runcode" onclick="get_domain_change('/admin/container/domain?id=<?php echo $value->id?>')"><button type="button" class="btn btn-xs btn-warning">绑定域名</button></a></td>
                            <?php
