                ...
                <div class="col-md-2 bootstrap-admin-col-left">
                    ...
                    ?>
                        <li <?php if($class2 == "" || $class2 ="welcome") echo "class='active'" ?> >
                            <a href="<?php echo base_url();?>admin/welcome"><i class="glyphicon glyphicon-chevron-right"></i> 控制台</a>
                        </li>
                        <?php foreach ($permissions as $value) {?>
                            <li>
                                <a href="<?php echo base_url()."admin/".$value->col_route_name?>">
                                    <i class="glyphicon glyphicon-chevron-right"></i><?php echo $value->col_name?>
                                </a>
                            </li>
                        <?php } ?>
                    </ul>
