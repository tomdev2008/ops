        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
               ...
               <!--                      <li class="divider"></li>
                            ...
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown">内部工具 <i class="caret"></i>
...
<?php
    echo form_hidden('hidden_loguser_id', $hidden_loguser_id);
?>
...
<?php }
elseif ($hidden_loguser_id == 1) {  ?>
    <tr>
    <td><strong>ssh访问权限</strong></td>
    <td>Loguser权限</td>
    </tr>
<?php }elseif ($hidden_loguser_id == 2) { ?>
<tr>
    <td><strong>ssh访问权限</strong></td>
    <td>root权限</td>
    </tr>
