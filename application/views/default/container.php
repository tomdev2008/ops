...
?>
                        ...
                        ?>                                         
                                            ...
                                            <?php
                                                if ($i == 1) {
                                            ?>
                                            <td style="vertical-align:middle;text-align:center;" rowspan="<?php echo $ip_data_count?>">
...
server{
        ...
        location / {
                ...
                include proxy.conf;
                                            ...
                                            ?>
                                                <td>&nbsp;<span class="label label-inverse"><?php echo $value_ip->server_type.$value_ip->id?></td>
                                               <td><?php echo $value_ip->server_deploy_ip.':'.$value_ip->server_deploy_port?><br>
                                                    <?php echo $value_ip->server_name?>
                                                </td>
                                                <td><?php echo $value_ip->server_alias_name; //echo anchor('container#', ' 查看日志', 'title="查看日志"');?></td> 
                                                <td><?php if($value_ip->server_status == 1) {?><span class="label label-success">已部署</span>
