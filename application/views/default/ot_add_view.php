<!--  <div style=" position:absolute; left:0; top:0px; width:100%; height:100%"> -->
                <div class="span9" id="content" style=" position:absolute; lleft:50px; right:50px;top:0px; width:90%; height:90%">
                     <!-- validation -->
                    <div class="row-fluid">
                         <!-- block -->
                        <div class="block" >
                          <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left">添加人员加班信息</div>
                                </div>
                              <div class="block-content collapse in">
                                  <div class="span12">
<?php
    $attributes = ['class' => 'form-horizontal', 'id' => 'form_sample_1'];
    echo form_open('ot/add_view', $attributes);
    echo form_hidden('name_id', $name_id);
    echo form_hidden('ot_date', $ot_date);
    $m = (substr($ot_date,0,2));
    $d = (substr($ot_date,2,2));
    $y = date("Y");
    echo '<br>';
?>
    <fieldset>
    ...
    <div class="control-group">
          ...
          <div class="control-group">
                  ...
                  <div class="controls">
                 <input class="laydate-icon" name="start_time" id="start" style="width:200px; margin-right:10px;" />
            </div>
                </div>
                <?php echo '<br>';?>
        <div class="control-group">
                  ...
                  <div class="controls">
                 <input class="laydate-icon" name="end_time" id="end" style="width:200px;" />
                  </div>
                </div>
...
<!--/.fluid-container-->
  ...
  <script src="http://ops.xkeshi.so/laydate/laydate.js"></script> 
 ...
 <script>
        var start = {
          ...
          start: '<?php echo $y.'-'.$m.'-'.$d.' 22:00:00';?>',  //开始日期
          istime: true,
