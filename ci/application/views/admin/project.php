                            ...
                            <div class="bootstrap-admin-panel-content">
                                ...
                                ?>        
                                            <tr class="odd gradeX">
                                                ...
                                                <td><a href="/admin/project/container?server_project=<?php echo $value->id?>"><?php echo $value->name;echo '  '?></a><span class="label label-info"><?php echo $value->alias_name?></span>&nbsp;<span class="label label-success"><?php echo $this->project_model->get_name_by_id($value->user_id)?></span> </td>
                                                <td><a href="project/container?container_env=1&server_project=<?php echo $value->id?>" target="_blank">列表</a><a href="javascript:;" class="runcode" onclick="get_project_change('/admin/project/nginx?container_env=1&server_project=<?php echo $value->id?>')"><button type="button" class="btn btn-xs btn-success">nginx模板</button></a></td>
                                                 <td><a href="project/container?container_env=2&server_project=<?php echo $value->id?>" target="_blank">列表</a><a href="javascript:;" class="runcode" onclick="get_project_change('/admin/project/nginx?container_env=2&server_project=<?php echo $value->id?>')"><button type="button" class="btn btn-xs btn-success">nginx模板</button></a></td>
                                                 <td><a href="project/container?container_env=3&server_project=<?php echo $value->id?>" target="_blank">列表</a><a href="javascript:;" class="runcode" onclick="get_project_change('/admin/project/nginx?container_env=3&server_project=<?php echo $value->id?>')"><button type="button" class="btn btn-xs btn-success">nginx模板</button></a></td>
                                                 <td><a href="project/container?container_env=4&server_project=<?php echo $value->id?>" target="_blank">列表</a><a href="javascript:;" class="runcode" onclick="get_project_change('/admin/project/nginx?container_env=4&server_project=<?php echo $value->id?>')"><button type="button" class="btn btn-xs btn-success">nginx模板</button></a></td>
                                              <td class="actions">
