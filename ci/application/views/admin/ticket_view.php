...
?>
              ...
              <div class="control-group">
                  ...
                  <td><?php echo $this->ticket_model->ubbReplace($value->contents)?></td><!-- $haha =  -->
              ...
              <div class="control-group warning" >
                ...
                <label class="control-label" for="inputError" ><strong>留言板</strong></label>
                  ...
                  <p><a class="emotion" style="cursor:pointer;"><img id="meme" style="cursor:pointer;" src="<?php echo base_url();?>qqface/arclist/icon.jpg" border="0" width="24" height="24">表情</a></p>
                    <textarea name="contents" id="contents" class="form-control textarea-wysihtml5" placeholder="请输入您的留言..." style="width: 100%; height: 200px"></textarea>
