                ...
                <div class="col-md-10">
                    <div class="row">
                      ...
                      <p><?php echo anchor('admin/platform/add', '新增分组 <i class="glyphicon glyphicon-plus glyphicon-white"></i>', 'class="btn btn-primary" title="新增分组"');?></p>
                        <div class="col-lg-14">
        ...
        <script type="text/javascript" src="<?php echo base_url();?>admin-static/vendors/bootstrap-switch/build/js/bootstrap-switch.min.js"></script>
