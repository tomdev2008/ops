	                            ...
	                            <div class="panel panel-default bootstrap-admin-no-table-panel">
								    ...
								    ?>
										...
										<div class="form-group" style="margin-left: 25%;margin-top:20px">
						                    ...
						                    <button type="button" class="btn btn-default"  onclick="location.reload();">恢复版本号</button>
						                      	<button type="submit" class="btn btn-primary" id="btn" style="margin-left:30px" onclick="return check();">确认提交</button>
						                    </div>
						                </div>
								</div>
							</div>
