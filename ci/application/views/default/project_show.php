...
<?php
    ...
    // echo "<font size=5>项目Jenkins名称：<strong>".$ServerName.
    //   "</strong><br />项目中文名称：<strong>".$alias_name.
    //   "</strong><br />项目部署环境：<strong>".$env.
    //   "</strong><br />项目容器：<strong>".$server_type.
    //   "</strong><br />服务器IP：<strong>".$server." </strong>端口号:<strong>".$port."</strong><br />
    //   运维组正在构建中，请稍等。
    //   </font>";
?>
